...
Devise.setup do |config|
  ...
  # Set this in the host application and add to a values stored in secrets
  ...
  # time the user will be asked for credentials again. Default is 20 minutes.
  config.timeout_in = Renalware.config.session_timeout.minutes
