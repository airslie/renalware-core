...
When(/^the Clinician records the episode of peritonitis$/) do
  ...
  select "Rifampin", from: "Select Drug (common peritonitis drugs listed at the top)", match: :first
...
When(/^they add a medication to this episode of peritonitis$/) do
  ...
  select "Penicillin", from: "Select Drug (common peritonitis drugs listed at the top)", match: :first
