Feature: Determining observations required based on global rules
  ...
  Scenario Outline: The required observations were determined based on the date of the last observation and the requency.
  ...
  Scenario Outline: The required observations were determined based on the date of the last request and request expiration.
    ...
    Examples:
      ...
      | Always         |                |               | required      |
      | Always         | 1 days ago     |               | not required  |
      | Always         | 1 days ago     | 6 days ago    | not required  |
      | Always         | 1 days ago     | 8 days ago    | not required  |
      ...
      | Weekly         |                |               | required      |
      | Weekly         | 1 days ago     |               | not required  |
      | Weekly         | 1 days ago     | 6 days ago    | not required  |
      | Weekly         | 1 days ago     | 8 days ago    | not required  |
      | Weekly         | 6 days ago     |               | not required  |
      | Weekly         | 6 days ago     | 1 days ago    | not required  |
      | Weekly         | 6 days ago     | 8 days ago    | not required  |
      | Weekly         | 7 days ago     |               | required      |
      | Weekly         | 7 days ago     | 1 days ago    | not required  |
