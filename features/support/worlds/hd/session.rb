    ...
    module Domain
      ...
      def seed_hd_sessions(table)
        table.hashes.each do |row|
          signed_on_by = find_or_create_user(given_name: row[:signed_on_by], role: "read_write")
          signed_off_by = find_or_create_user(given_name: row[:signed_off_by], role: "read_write")
