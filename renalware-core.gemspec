...
Gem::Specification.new do |s|
  ...
  s.add_dependency "psych", "< 4" # required for ruby 3.x to avoid invalid database.yml error
  ...
  s.add_dependency "turbo-rails", "1.4.0" # matches "@hotwired/turbo-rails" => "7.3.0"
