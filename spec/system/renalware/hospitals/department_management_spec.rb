...
describe "Department Management" do
  ...
  it "add a department" do
    ...
    visit hospitals_centres_path

    expect(page).to have_content("HospA")

    within("table tr#hospitals_centre_#{centre.id} .departments_count") do
      click_on "View"
    end

    expect(page).to have_current_path(hospitals_centre_departments_path(centre))
  ...
  it "edit a department" do
    ...
    visit hospitals_centre_departments_path(centre)

    within("table tr#hospitals_department_#{department.id}") do
      click_on t("btn.edit")
    end
