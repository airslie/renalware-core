...
describe "API request for a single patient JSON document" do
  ...
  describe "GET JSON #show" do
    ...
    it "renders patient json" do
      ...
      expect(json).to eq(
        ...
        "prescriptions_url" =>
          api_v1_patient_prescriptions_path(patient_id: patient),
        "hd_profile_url" =>
          api_v1_patient_hd_current_profile_path(patient_id: patient)
      )
    end
  end
