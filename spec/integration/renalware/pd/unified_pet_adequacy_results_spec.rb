...
describe "Managing PD PET Adequacy Results", type: :request do
  let(:patient) { Renalware::PD.cast_patient(create(:patient, by: user)) }
  let(:user) { create(:user) }

  describe "GET new" do
    it "responds with a form" do
      get new_patient_pd_unified_pet_adequacy_path(patient)
  ...
  #     post patient_pd_pet_results_path(patient, params)
