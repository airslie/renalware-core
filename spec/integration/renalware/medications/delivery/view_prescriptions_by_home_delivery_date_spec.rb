...
describe "View a list of home delivery prescriptions filtered by delivery dates", type: :system do
  ...
  it "displays matching esa prescriptions" do
    ...
    travel_to Date.parse("01-12-2020") do
      ...
      expect(page).to have_content(I18n.l(prescription.prescribed_on))
