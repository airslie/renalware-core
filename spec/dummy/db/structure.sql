...
CREATE TABLE renalware.pd_adequacy_results (
    ...
    patient_id bigint NOT NULL,
    performed_on date NOT NULL,
    dial_24_vol_in double precision,
    dial_24_vol_out double precision,
    dial_24_missing boolean DEFAULT false NOT NULL,
    urine_24_vol double precision,
...
CREATE TABLE renalware.pd_pet_results (
    ...
    volume_in double precision,
    volume_out double precision,
    dextrose double precision,
    infusion_time integer,
    drain_time integer,
    overnight_volume_in double precision,
    overnight_volume_out double precision,
