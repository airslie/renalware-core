  ...
  describe Part::Prescriptions do
    ...
    describe "self" do
      it "returns an OpenStruct of different sets of prescriptions" do
        ...
        expect(part).to respond_to(:current_hd)
    ...
    describe "#current" do
      it "comprises only current prescriptions" do
        ...
        expect(part.current.to_a).to eq([current_non_hd])
      end
    end
    ...
    describe "#recently_changed" do
      it "comprises only prescriptions changed in the last 14 days" do
        ...
        expect(part.recently_changed.to_a.sort).to eq([recently_changed, recently_changed_hd])
      end
    end
    ...
    describe "#current_hd" do
      it "comprises current prescriptions to give on HD only" do
        ...
        expect(part.current_hd.to_a).to eq([current_hd_prescription])
      end
    end
  end
end
