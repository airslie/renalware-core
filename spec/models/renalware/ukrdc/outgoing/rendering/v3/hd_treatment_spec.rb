...
module Renalware
  module UKRDC
    module Outgoing
      describe Rendering::V3::HDTreatment do
        include XmlSpecHelper

        before { allow(Renalware.config).to receive(:ukrdc_site_code).and_return("XXX") }

        it "renders the hospital unit type as the RR8 QBL05 code" do
          ...
          expect(xml).to match("<Attributes><QBL05>HOSP</QBL05></Attributes>")
        end
      end
    end
  end
