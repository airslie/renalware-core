...
module Renalware
  module Transplants
    describe DonorStage do
      ...
      it { is_expected.to belong_to(:donor_stage_position) }
      it { is_expected.to validate_presence_of(:donor_stage_position) }
      ...
      it { is_expected.to validate_presence_of(:donor_stage_status) }
