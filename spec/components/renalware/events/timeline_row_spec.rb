...
module Renalware
  RSpec.describe Events::TimelineRow do
    ...
    it "renders component" do
      expect(table_fragment.text).to include("09-Jul-2025EventSimple Event")
    ...
    context "when component is not within Events module" do
      ...
      it "renders component" do
        expect(table_fragment.text).to include("09-Jul-2025EventRemote Monitoring Registration")
