...
# When expanded, the link changes to 'Less...' and will unexpand the text.
...
#
# A failing of this component is that it does not hide the More.. when it is not neccessary
