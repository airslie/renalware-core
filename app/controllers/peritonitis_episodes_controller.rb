class PeritonitisEpisodesController < ApplicationController
  ...
  def new
    ...
    @peritonitis_episode.medications.build 
  end
  ...
  def allowed_params
    params.require(:peritonitis_episode).permit(:user_id, :diagnosis_date, :start_treatment_date, :end_treatment_date, 
      ...
      :medications_attributes => [:id, :treatable_id, :treatable_type, :medicatable_id, :medicatable_type, :medication_type, :dose, :medication_route_id,
