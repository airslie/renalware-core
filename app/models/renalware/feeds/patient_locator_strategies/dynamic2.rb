      ...
      class Dynamic2
        ...
        def call # rubocop:disable Metrics/MethodLength
          ...
          if msg_contains_nhs_number?
            ...
            patient = find_patient_by_dob_and_mrn || find_patient_by_mrn_and_name
        ...
        def find_patient_by_mrn_and_name
          return unless local_patient_id_identifiers?

          patients = find_by_mrn_and_name
          raise(Error, "Possible duplicate matching DOB + MRN") if patients.length > 1
        ...
        def find_by_mrn_and_name
          Renalware::Patient
            .where("lower(family_name) = ?", patient_identification.family_name.downcase)
            .merge(match_on_any_mrn)
        end
