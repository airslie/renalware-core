...
module Renalware
  module Letters::Delivery::TransferOfCare
    # An FHIR resource
    class Resources::AllergyIntolerance
      ...
      def call
        {
          ...
          resource: FHIR::STU3::AllergyIntolerance.new(
            ...
            # NB: clinicalStatus and verificationStatus are defined as CodeableConcepts in FHIR
            # spec but in the NHS example for ToC its just a string which does not validate
            # Need to investigate
