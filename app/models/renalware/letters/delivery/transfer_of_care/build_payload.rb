...
module Renalware
  module Letters::Delivery::TransferOfCare
    ...
    # This XML is a representation of the letter, and will be sent over
    # MESHAPI to the patient's GP. It contains the letter HTML (split into the required 'sections')
    # plus various structured data about medications etc.
    # See https://digital.nhs.uk/services/interoperability-toolkit/developer-resources/transfer-of-
    # care-specification-versions
    #
    class BuildPayload
      include Callable
      ...
      def arguments
        @arguments ||= Arguments.new(transmission: transmission, transaction_uuid: transaction_uuid)
      end
    end
  end
end
