select
  ...
  (select count(*) from letter_letters where type = 'Renalware::Letters::Letter::Draft' and created_at < (current_date - interval '14 days')) as draft_letters_older_than_14_days;
