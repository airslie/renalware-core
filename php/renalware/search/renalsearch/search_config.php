...
$availfieldslist="patzid,hospno1,hospno2,hospno3,hospno4,nhsno,lastname,firstnames,modalsite,postcode,gp_name,healthauthcode,refer_date,firstseendate,accessCurrDate,accessPlanner,accessPlandate,accessLastAssessdate,accessRxDecision,accessSurveillance,accessAssessOutcome,esdstartdate,esdmodifdate,prescriber,esrfweight,lowFirstseendate,lowDialPlandate,lowPredictedESRFdate,txWaitListEntryDate,txWaitListModifDate,diabetesflag,hivflag"; // in search/custom popups
