...
<?php if ($wardclerkflag): ?>
	<a class="ui-state-default" style="color: purple;" href="admissions/dischargesummlist.php?show=outstanding&amp;dedupe=yes">Remove Duplicates</a>
<?php endif ?>
</p>
<?php
...
$numrows=$result->num_rows;
	echo "<p class=\"header\">$numrows $displaytext located.</p>";
