...
if (!$numrows)
	{
	bs_Para("danger","No letters recorded!");
	}
else
	{
	bs_Para("danger","$numtotal $displaytext ($numrows displayed). (Toggle to view text.) Numbers in brackets indicate word count.");
	...
	while ($row = $result->fetch_assoc())
		...
		$showhide = "<a onclick=\"$('#lett$lettid').toggle();\">toggle</a>";
