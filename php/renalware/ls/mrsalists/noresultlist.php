...
$listcode="mrsa";
$listtable="mrsadata";
$listitems="MRSA swabs awaiting results";
...
$where="WHERE swabresult is NULL";
$listnotes="Displaying all MRSA swabs without results. Links open in new windows. Click on headers to sort. The Search operates across all fields.";
