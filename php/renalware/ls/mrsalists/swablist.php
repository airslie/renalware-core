...
$where="";
$listnotes="Displaying all recorded MRSA swabs; Links open in new windows. Click on headers to sort. The Search operates across all fields.";
