...
$where="WHERE (DATEDIFF(CURDATE(),adddate)<31 or DATEDIFF(CURDATE(),termdate)<31) AND medsdata.immunosuppflag=1 AND immunosuppdrugdelivery='HospHomeDelivery'";
