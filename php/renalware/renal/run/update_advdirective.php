...
$updatefields="modifstamp=NOW(),advancedirflag='Y',advancedirdate=NOW()";
...
//log the event
$eventtype="Patient Adv Directive Info updated";
$eventtext=$mysqli->real_escape_string($sql);
include "$rwarepath/run/logevent.php";
$runmsgtxt="Thank you. The Adv Directive details have been updated.";
