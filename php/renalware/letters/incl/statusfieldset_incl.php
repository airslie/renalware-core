...
<p><input type="radio" name="stage" value="refresh" checked="checked" /><b>SAVE/REFRESH and view changes</b> or <a href="letters/previewletter.php?zid=<?php echo $zid ?>&amp;letter_id=<?php echo $letter_id ?>" >view in new window (for pagebreak preview)</a></p>
