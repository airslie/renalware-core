...
<form action="sharedcare/add_form.php" method="get" accept-charset="utf-8" role="form">
<fieldset>
...
if ($numrows) {
	...
	while($row = $result->fetch_assoc())
		...
		echo "<tr>";
		//options links
		echo '<td><a href="sharedcare/show_addform.php?zid='.$zid.'">Add form</a></td>';
...
<?php if ($get_mode=="find"): ?>
    <form class="well" action="sharedcare/add_form.php" method="get" accept-charset="utf-8" role="form">
        <fieldset>
        <input type="hidden" name="mode" value="find" id="mode">
        <div class="form-group">
