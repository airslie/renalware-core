...
# rubocop:disable RSpec/ExampleLength, Metrics/ModuleLength, RSpec/DescribeClass
module Renalware
      ...
      describe ":data" do
        ...
        context "when there are rows in the report" do
          it "is correctly generates json" do
            ...
            expect(result[:data].sort_by { |a| a[:modality] }).to eq(
              [
                {
                  modality: "HD",
                  patient_count: 4,
...
# rubocop:enable RSpec/ExampleLength, Metrics/ModuleLength, RSpec/DescribeClass
