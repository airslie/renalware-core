...
describe "Snippet management" do
  let(:user) { Renalware::Snippeting.cast_user(@current_user) }

  describe "GET index" do
    it "responds successfully" do
      get snippeting.snippets_path
  ...
  describe "GET new" do
    it "responds with a form" do
      get snippeting.new_snippet_path
  ...
  describe "POST create" do
    context "with valid params" do
      it "successfully and creates a new snippet" do
        ...
        post(snippeting.snippets_path, params: params)
  ...
  describe "GET edit" do
    it "responds with a form" do
      ...
      get snippeting.edit_snippet_path(snippet)
  ...
  describe "PATH update" do
    context "with valid params" do
      it "updates snippet and redirects to #index" do
        ...
        patch snippeting.snippet_path(snippet, params: params)
