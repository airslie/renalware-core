  ...
  module Snippeting
    class SnippetsController < BaseController
      ...
      def create
        ...
        snippet.author = Snippeting.cast_user(current_user)
        authorize snippet

        if snippet.save
          redirect_to snippeting.snippets_path, notice: success_msg_for("snippet")
        else
      ...
      def destroy
        ...
        redirect_to snippeting.snippets_path
      end
